...
print (r.shape)
#%% une image couleur 
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/fleur.tif')
...
viewimage(im)
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/lena.tif')
viewimage(im)
im2=rotation(im,45,ech=0,alpha=1/2)
viewimage(im2)
im3=rotation(im,45,ech=1,alpha=1/2)
viewimage(im3)
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/lena.tif')
viewimage(im)
for i in range (8):
    im=rotation(im,45,ech=0,clip=True)
viewimage(im)
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/lena.tif')
for i in range (8):
    im=rotation(im,45,ech=1,clip=True)
viewimage(im)
#%%
mask = get_gau_ker(10)
viewimage(mask)
...
plt.show()
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/pyramide.tif')
imbr=noise(im,10)
viewimage_color(imbr)

mask1 = get_gau_ker(1)
mask5 = get_gau_ker(5)
mask3 = get_gau_ker(3)
image_filtr = filtre_lineaire(imbr, mask1)
viewimage(image_filtr)

image_filtr = filtre_lineaire(imbr, mask3)
viewimage(image_filtr)

image_filtr = filtre_lineaire(imbr, mask5)
viewimage(image_filtr)

#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/carre_orig.tif')
viewimage(im)

image_filtr = filtre_lineaire(im, mask3)
viewimage(image_filtr)

image_filtr = median_filter(im)
viewimage(image_filtr)
...
image_filtr_br=noise(image_filtr,1)
viewimage(image_filtr_br)

image=filtre_inverse(image_filtr_br, mask5)
viewimage(image)
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/carre_flou.tif')
viewimage(im)

imbr=noise(im,10)
viewimage(imbr)
K = np.array([[0,0,1],[1,1,1],[0,0,1]] )
imf=wiener(imbr,K,1000)
viewimage(imf)
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP2/images/carre_flou.tif')
viewimage(im)
...
def comparaison():
    L=[]
    im_filtr_median=median_filter(imbr,r=4)
    viewimage(im_filtr_median)
    
    for i in range (10):
        image_filtr = filtre_lineaire(imbr, get_cst_ker(i))
        L.append(image_filtr)
        var_image(abs(im_filtr_median-image_filtr),10, 100, 200, 300)
