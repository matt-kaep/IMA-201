...
#%% charger une image 
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/maison.tif')
...
print (r.shape)
#%% une image couleur 
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/TP1/images/fleur.tif')
...
(histo,bins)=np.histogram(im,np.arange(0,256))
plt.plot(histo)
plt.show()
...
imb=noise(im,10)
viewimage(imb)
(histo,bins)=np.histogram(imb,np.arange(0,256))
plt.plot(histo)
plt.show()
histo=histo/histo.sum()
histocum=histo.cumsum()
...
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/sombre.jpg')
...
imequal=histocum[im]*256
viewimage(imequal)

(histoimequal,bins)=np.histogram(imequal,np.arange(0,256))
plt.plot(histoimequal)
plt.show()
histoimequal=histoimequal/histoimequal.sum()
histoimequalcum=histoimequal.cumsum()
plt.plot(histoimequalcum)
plt.show()
...
#%% 
u=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/masque_bas_centre.tif')
v=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/masque_gauss_centre.tif')
viewimage(u)
viewimage(v)
...
im=seuil(noise(im,10),128)
viewimage(im)
#%%

im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/rayures.tif')
viewimage(im)

#%% FILTRE
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/maison.tif')
viewimage(im)
viewimage(filtergauss(im))
view_spectre(im,2,True)
view_spectre(filtergauss(im),2,True)


#%% log d'un histogramme
plt.plot(np.log(np.histogram(gradx(im),255)[0]))
#%%
im=skio.imread('/Users/matthieu.kaeppelin/Documents/4-TélécomParis/1-Cours/IMA/IMA201/images/lena.tif')
